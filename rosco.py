...
if 'rosco_data' not in st.session_state:
    st.session_state.rosco_data = [
        ...
        {"letra": "E", "tipo": "Comienza con", "pista": "acción de transmitir conocimientos y habilidades a otras personas.", "palabra": "ENSEÑAR", "ods": "ODS 4: Educación de Calidad"},
        {"letra": "F", "tipo": "Comienza con", "pista": "conjunto de animales que habitan mares y océanos y que deben protegerse de la sobreexplotación.", "palabra": "FAUNA", "ods": "ODS 14: Vida Submarina"},
        ...
        {"letra": "H", "tipo": "Comienza con", "pista": "conjunto de hábitos de limpieza que ayudan a prevenir enfermedades.", "palabra": "HIGIENE", "ods": "ODS 6: Agua Limpia y Saneamiento"},
        ...
        {"letra": "K", "tipo": "Comienza con", "pista": "unidad de potencia usada para medir el consumo eléctrico.", "palabra": "KILOVATIO", "ods": "ODS 7: Energía Asequible y No Contaminante"},
        ...
        {"letra": "W", "tipo": "Comienza con", "pista": "unidad que mide la potencia eléctrica de aparatos y sistemas de energía.", "palabra": "WATT", "ods": "ODS 7: Energía Asequible y No Contaminante"},
        {"letra": "X", "tipo": "Comienza con", "pista": "rechazo o miedo irracional hacia personas de otras culturas o países.", "palabra": "XENOFOBIA", "ods": "ODS 10: Reducción de Desigualdades"},
